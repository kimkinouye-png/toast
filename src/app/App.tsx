...
export default function App() {
  ...
  const oldSlides = [
    ...
    <ChapterIntro
      ...
      subtitle="How I built operational infrastructure for a 300-person global design organization at PayPal"
      ghostNumber="01"
    />,

    <Statement
      key="3"
      text="In 2019, PayPal's design org had 345 people and zero operational systems."
    />,

    <HeadlineVisual
      key="4"
      eyebrow="The Challenge"
      headline="From chaos to efficiency without losing velocity"
    >
      <EfficiencyChart />
    </HeadlineVisual>,
    ...
    <HeadlineStats
      key="6"
      eyebrow="The Scale"
      headline={{ text: "Operating at global scale", italic: true }}
      stats={[
        { label: "Design Org", value: "300", description: "Global design team members" },
        { label: "Geographies", value: "12", description: "Countries across 4 continents" },
        { label: "Products", value: "50+", description: "Active product lines" }
      ]}
    />,
    ...
    <HeadlineStats
      key="7"
      eyebrow="The Problem"
      headline={{ text: "Designers were drowning in overhead", italic: false }}
      stats={[
        { label: "Meeting Load", value: "74%", description: "Of designer time in meetings", color: colors.red },
        { label: "Context Switching", value: "12x", description: "Average switches per day", color: colors.red },
        { label: "Focus Time", value: "26%", description: "Available for actual design", color: colors.red }
      ]}
    />,
    ...
    <HeadlineVisual
      ...
      headline="Organizing work into clear, manageable portfolios"
    >
      <AsanaBacklog />
    </HeadlineVisual>,
    ...
    <HeadlineVisual
      key="9"
      eyebrow="Meeting Redesign"
      headline="Ruthlessly restructuring how designers collaborate"
    >
      <MeetingEvolution />
    </HeadlineVisual>,
    ...
    <HeadlineVisual
      key="10"
      eyebrow="Calendar Analysis"
      headline="Reclaiming focus time for deep work"
    >
      <CalendarComparison />
    </HeadlineVisual>,
    ...
    <Statement
      key="11"
      text="The goal isn't fewer meetings. It's more time in the Zone of Genius."
    />,

    <HeadlineStats
      key="12"
      eyebrow="The Impact"
      headline={{ text: "Measurable improvements across the org", italic: true }}
      stats={[
        { label: "Time Saved", value: "40%", description: "Reduction in meeting overhead", color: colors.teal },
        { label: "Focus Time", value: "66%", description: "Now available for design work", color: colors.teal },
        { label: "Satisfaction", value: "+32%", description: "Designer satisfaction scores", color: colors.teal }
      ]}
    />,
    ...
    <HeadlineStats
      ...
      headline={{ text: "Five org-wide portfolios", italic: false }}
      stats={[
        { label: "Consumer", value: "47", description: "Active projects" },
        { label: "Merchant", value: "38", description: "Active projects" },
        { label: "Platforms", value: "29", description: "Active projects" }
      ]}
    />,
    ...
    <ChapterIntro
      ...
      eyebrow="Chapter Two"
      title="AI Pilots"
      subtitle="How I designed and ran an AI transformation program that delivered 75-84% time savings"
      ghostNumber="02"
    />,
    ...
    <FromTo
      ...
      eyebrow="The Vision"
      fromTitle="From"
      fromContent="AI as a buzzword. Scattered experiments. No clear ROI. Designers skeptical and overwhelmed."
      toTitle="To"
      toContent="AI as infrastructure. Repeatable pilots. Proven impact. Designers empowered and effective."
    />,

    <Statement
      key="16"
      text="The question wasn't whether AI would change design work. It was whether we'd shape that change or react to it."
    />,

    <HeadlineStats
      key="17"
      eyebrow="The Approach"
      headline={{ text: "A repeatable model for AI adoption", italic: true }}
      stats={[
        { label: "Step 1", value: "01", description: "Identify friction in workflows" },
        { label: "Step 2", value: "02", description: "Design a focused test" },
        { label: "Step 3", value: "03", description: "Measure impact rigorously" },
        { label: "Step 4", value: "04", description: "Scale what works" }
      ]}
    />,
    ...
    <HeadlineVisual
      key="18"
      eyebrow="The Results"
      headline="Real numbers from real pilots"
    >
      <ProofNumbers />
    </HeadlineVisual>,
    ...
    <Statement
      key="19"
      text="We ran 8 pilots. 9 of 25 workstreams adopted AI tools. Time savings ranged from 75-84%."
    />,

    <HeadlineStats
      key="20"
      eyebrow="Pilot Examples"
      headline={{ text: "Where AI had the biggest impact", italic: false }}
      stats={[
        { label: "Research Synthesis", value: "84%", description: "Time saved on analysis", color: colors.teal },
        { label: "Design QA", value: "78%", description: "Faster accessibility checks", color: colors.teal },
        { label: "Documentation", value: "75%", description: "Automated spec generation", color: colors.teal }
      ]}
    />,

    <Statement
      key="21"
      text="The best pilot wasn't the one with the highest ROI. It was the one designers actually used."
    />,

    // Chapter 3: Tools I Built
    <ChapterIntro
      key="22"
      eyebrow="Chapter Three"
      title="Tools I Built"
      subtitle="Two personal tools: a capacity planner and Rose, an AI feedback decoder"
      ghostNumber="03"
    />,
    ...
    <HeadlineStats
      ...
      headline={{ text: "Making resource allocation visible", italic: true }}
      stats={[
        { label: "Teams", value: "18", description: "Design teams using it" },
        { label: "Projects", value: "200+", description: "Tracked simultaneously" },
        { label: "Accuracy", value: "94%", description: "Forecast vs. actual" }
      ]}
    />,

    <Statement
      key="24"
      text="You can't balance workload if you can't see it."
    />,

    <HeadlineVisual
      key="25"
      eyebrow="Rose: AI Feedback Coach"
      headline="Turning messy feedback into actionable insights"
    >
      <RoseDiagram />
    </HeadlineVisual>,
    ...
    <FromTo
      ...
      eyebrow="Rose Impact"
      fromTitle="Before"
      fromContent="Designers spent 6-8 hours per week manually coding feedback, looking for patterns, and prioritizing actions."
      toTitle="After"
      toContent="Rose analyzes feedback in real-time, surfaces patterns, and recommends priorities. Designers spend 1-2 hours reviewing insights."
    />,

    <HeadlineStats
      key="27"
      eyebrow="Rose Metrics"
      headline={{ text: "Proven impact on research workflows", italic: false }}
      stats={[
        { label: "Time Saved", value: "75%", description: "On feedback analysis", color: colors.teal },
        { label: "Pattern Detection", value: "3x", description: "More patterns found", color: colors.teal },
        { label: "Action Items", value: "92%", description: "Accuracy on prioritization", color: colors.teal }
      ]}
    />,

    <Statement
      key="28"
      text="Rose doesn't replace designer judgment. It amplifies it."
    />,

    // Closing slides
    <Statement
      key="29"
      text="This is the work I love: building systems that let talented people do their best work."
    />,

    <Statement
      key="30"
      text="The difference between thriving and drowning is often infrastructure. Not talent. Not effort. Not intentions. Just the absence of systems that let people do their best work."
    />,
    ...
    <ChapterIntro
      ...
      eyebrow="Thank You"
      title="Questions?"
      subtitle="Kim Inouye · Principal Design Operations Program Manager"
      ghostNumber=""
    />,
