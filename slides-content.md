# Portfolio Presentation - Content Editor

This file contains all slide headlines and speaker notes for easy bulk editing.
...
## Slide 2
**Template:** Quote  
**Quote Text:** Creating something new is easy. Creating something that can last is the challenge.  
**Author:** Simon Sinek
...
## Slide 4 - CHAPTER 1: WAYS OF WORKING
...
## Slide 12
**Template:** Quote  
**Quote Text:** We couldn't have gotten up and running in Asana without you. But just as important, you've guided us in how to use it to support the team planning processes you've set up for us.  
...
## Slide 13
**Template:** Quote  
**Quote Text:** I just wanted to send a BIG thank you for taking time out of your busy calendars to help the post-purchase team properly use and adopt Asana!  
...
## Slide 25
**Template:** HeadlineStats  
**Eyebrow:** The results  
**Headline:** The team didn't stop to transform. They transformed while shipping.  
**Stats:**
- months: 6 - From pilot to scale
- pilots: 8 - Designed and tested
- workstreams: 9/25 - Adopted AI tools
- time saved: 75-84% - At the task level (teal color)
...
## Slide 26 - CHAPTER 3: TOOLS I BUILD
**Template:** ChapterIntro  
**Eyebrow:** Case Study 03  
